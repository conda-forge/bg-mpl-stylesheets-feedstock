About bg-mpl-stylesheets-feedstock
==================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/bg-mpl-stylesheets-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/bg-mpl-stylesheets-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add bg-mpl-stylesheets
# for installing globally
pixi global install bg-mpl-stylesheets
```
...
It is possible to list all of the versions of `bg-mpl-stylesheets` available on your platform:
...
```
pixi search bg-mpl-stylesheets --channel conda-forge
```
